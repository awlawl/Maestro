...
namespace Website.Routes
{
    ...
    {
        private bool _showAlbumArt = false;
        ...
        public AlbumArtRoute()
        {
            var albumArtSetting = ConfigurationManager.AppSettings["ShowAlbumArt"];
            if (string.IsNullOrEmpty(albumArtSetting))
                _showAlbumArt = false;
            else
                _showAlbumArt = bool.Parse(albumArtSetting);
        }
